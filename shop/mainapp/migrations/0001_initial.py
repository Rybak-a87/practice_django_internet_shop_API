    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sd_volume_max', models.CharField(blank=True, max_length=255, null=True, verbose_name='Максимальный объем SD карты')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, null=True, verbose_name='Комментаний к заказу')),
